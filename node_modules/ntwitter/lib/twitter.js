...
Twitter.prototype.retweet = function(id, params, callback){
	var url = '/statuses/retweet/' + escape(id) + '.json';
	this.post(url, params, null, callback);
	return this;
}
...
Twitter.prototype.createFavorite = function(tweetid, params, callback) {
...
Twitter.prototype.destroyFavorite = function(tweetid, params, callback) {
